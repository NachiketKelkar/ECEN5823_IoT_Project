...
## Project update 2
* The functionality to provision lightness model and level model added.
* The provisioning of vendor model is under development. 
* The out of band authentication functionality is under test but not working.

## Project Final Update
* The provisioner is able to provison all the models of all the nodes.
